...
# CS
export moria="karpel@moria.cs.wisc.edu"
...
export jup1="karpel@jupyter0001.chtc.wisc.edu"

export phenocm="karpel@htpheno-cm.chtc.wisc.edu"
export phenosub="karpel@htpheno-submit.chtc.wisc.edu"
